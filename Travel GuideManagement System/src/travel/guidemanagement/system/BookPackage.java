...
public class BookPackage extends JFrame {
	...
	public BookPackage(String username) {
		...
		contentPane.add(lblId);
                ...
                c1.add("SPIRITUAL TOUR");
                c1.add("Jaipur Heritage");
                c1.add("Adventurous Motorbike Tour");
		...
		b1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                            ...
                            int cost = 0;
                            switch (p) {
                                case "Gold Package" -> cost += 12000;
                                case "Silver Package" -> cost += 25000;
                                case "Bronze Package" -> cost += 32000;
                                case "SPIRITUAL TOUR" -> cost += 11100;
                                case "Jaipur Heritage" -> cost += 7000;
                                case "Adventurous Motorbike Tour" -> cost += 30000;
                                default -> {
                                }
                            }
