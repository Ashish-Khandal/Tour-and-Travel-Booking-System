...
public class CheckHotels extends JFrame implements Runnable {
    ...
    public void run() {
        try {
            ...
            l2.setVisible(false);
            l3.setVisible(true);
            caption.setText("Rambagh Palace Hotel");
            l3.add(caption);
            l3.setVisible(true);
            Thread.sleep(2800);
            l3.setVisible(false);
            l4.setVisible(true);
            caption.setText("Radisson Blu");
            l4.add(caption);
            Thread.sleep(2800);
            l4.setVisible(false);
            l5.setVisible(true);
            caption.setText("Lohagarh Fort Resort Hotel");
            l5.add(caption);
            Thread.sleep(2800);
            l5.setVisible(false);
            l6.setVisible(true);
            ...
            l9.setVisible(false);
            l10.setVisible(true);
            caption.setText("Hyatt Residency Mansarovar");
            l10.add(caption);
            Thread.sleep(2800);
    ...
    public CheckHotels() {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/rambagh1.jpeg"));
        ...
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/Radisson Blu.jpg"));
        ...
        ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/logarl2.jpg"));
        ...
        ImageIcon i16 = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/Holiday Inn.jpg"));
        ...
        ImageIcon i19 = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/Hyatt Residency Mansarovar.jpg"));
