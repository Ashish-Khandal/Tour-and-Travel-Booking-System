...
public class Dashboard extends JFrame {
    ...
    public Dashboard(String username) {
        ...
        NewLabel.setBounds(0, 0, 1500, 680);
        add(NewLabel);

        JLabel l1 = new JLabel("RAHGIR");
        l1.setForeground(Color.WHITE);
        l1.setFont(new Font("monotype corsiva", Font.BOLD, 55));
        l1.setBounds(550, 80, 1000, 100);
        NewLabel.add(l1);
        
        JLabel l2 = new JLabel("Your Tour and Travel Partner");
        l2.setForeground(Color.WHITE);
        l2.setFont(new Font("monotype corsiva", Font.ITALIC, 30));
        l2.setBounds(470, 150, 1000, 100);
        NewLabel.add(l2);
